...
class Command(BaseCommand):
    help = "Importa arquivo CSV/TXT da BLL para um processo usando o parser unificado."

    def add_arguments(self, parser):
        parser.add_argument("--processo-id", type=int, required=True, help="ID do Processo no sistema")
        parser.add_argument("--file", type=str, required=True, help="Caminho do arquivo CSV/TXT")
