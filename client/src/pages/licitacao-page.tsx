          ...
          <div className="space-y-4">
            <div className="overflow-x-auto rounded-[28px] border border-slate-200 bg-white">
              <Table className="min-w-[980px]">
                ...
                <TableBody>
                  {rows.map((row) => (
                    <TableRow key={row.processoId} className="transition hover:bg-slate-50">
                      <TableCell>
                        <div className="font-bold text-slate-950">{row.numeroSirel}</div>
                        <div className="text-xs text-slate-500">{row.modalidade ?? "Licitação"}</div>
                      </TableCell>
                      <TableCell>{row.secretaria}</TableCell>
                      <TableCell>
                        <div className="font-semibold text-slate-950">{row.etapaAtual}</div>
                        <div className="text-xs text-slate-500">{row.condutorNome ?? "Condutor definido apenas na publicação"}</div>
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell className="text-right">
                        <Link href={`/licitacao/${row.processoId}`} className="inline-flex items-center gap-2 rounded-2xl bg-slate-950 px-4 py-2 text-sm font-semibold text-white transition hover:bg-sky-700">
                          Abrir fase
